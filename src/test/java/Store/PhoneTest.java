...
public class PhoneTest {
    ...
    public void testtoString()  {
        ...
        Phone iphone = new Phone(1111, 45, Type.SENSOR, "10", "false", "USA");
        assertEquals(msg, iphone.toString());
    }

    private Phone iphone = new Phone(1111, 45, Type.SENSOR, "10", "false", "USA");
    @Test
    ...
    public void getSpecs() throws Exception {
        Phone newPhone = new Phone(1111, 45, Type.SENSOR, "10", "false", "USA");
